...
const AboutPage: React.FC = () => (
    <div className="min-h-screen bg-white dark:bg-background-dark text-black dark:text-white">
        ...
        <main className="max-w-4xl mx-auto px-6 md:px-10 py-20 md:py-32 space-y-20">
            <div>
                <p className="text-[9px] font-black uppercase tracking-[0.5em] opacity-40 mb-4">About Us</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border border-black/10 dark:border-white/10">
                {[
                    ...
                    <div key={s.label} className="p-8 border-r last:border-0 border-black/10 dark:border-white/10">
                        <p className="text-[8px] font-black uppercase tracking-widest opacity-40 mb-2">{s.label}</p>
                        <p className="text-2xl font-black uppercase tracking-tight">{s.value}</p>
                    </div>
                ))}
            </div>

            <div className="space-y-6 max-w-2xl">
                <h2 className="text-3xl font-black uppercase tracking-tight">Our Story</h2>
            ...
            <div className="border-t border-black/10 dark:border-white/10 pt-16">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <Link to="/contact" className="px-8 py-4 bg-black dark:bg-white text-white dark:text-black text-[10px] font-black uppercase tracking-widest hover:opacity-80 transition-opacity">
                        Contact Us
                    </Link>
                    <a href="mailto:hello@asterix-jobs.in" className="px-8 py-4 border border-black/20 dark:border-white/20 text-[10px] font-black uppercase tracking-widest hover:border-black dark:hover:border-white transition-colors">
