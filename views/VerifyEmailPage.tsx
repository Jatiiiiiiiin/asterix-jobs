    ...
    return (
        <div className="min-h-screen bg-white dark:bg-background-dark flex flex-col items-center justify-center p-6 space-y-10 animate-in fade-in duration-700">
            ...
            <div className="w-full max-w-[500px] border-2 border-black dark:border-white p-8 md:p-12 z-20 bg-white dark:bg-background-dark space-y-8 shadow-[20px_20px_0px_rgba(0,0,0,0.05)] dark:shadow-[20px_20px_0px_rgba(255,255,255,0.02)] text-center">
                ...
                <p className="text-[12px] font-bold uppercase tracking-widest opacity-60 leading-relaxed">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/10 border-2 border-amber-500/30 p-4 space-y-2 text-left">
                    <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Spam Alert</span>
                    </div>
                    <p className="text-[11px] font-bold uppercase tracking-wide text-amber-700/80 dark:text-amber-300/80 leading-snug">
                ...
                {message && (
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 rounded text-[10px] font-black uppercase tracking-widest text-green-700 dark:text-green-300">
                        {message}
                    </div>
                )}

                {error && (
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded text-[10px] font-black uppercase tracking-widest text-red-700 dark:text-red-300">
                        {error}
                    </div>
                )}
                ...
                <div className="space-y-4 pt-4">
                    <button
                        ...
                        className="w-full bg-black dark:bg-white text-white dark:text-black py-4 font-black uppercase tracking-[0.4em] text-[10px] hover:invert transition-all disabled:opacity-40 flex items-center justify-center gap-3"
                    >
                    ...
                    <button
                        ...
                        className="w-full border border-black dark:border-white py-4 font-black uppercase tracking-[0.4em] text-[10px] hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all flex items-center justify-center gap-3 disabled:opacity-40"
                    >
                ...
                <div className="pt-6 border-t border-black/5 dark:border-white/5">
                    <button
                        ...
                        className="text-[10px] font-black uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity flex items-center justify-center gap-2 mx-auto"
                    >
            ...
            <p className="text-[8px] font-black uppercase tracking-[0.4em] opacity-20 z-20">
